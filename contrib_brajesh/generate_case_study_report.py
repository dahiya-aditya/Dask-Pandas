...
BRAJESH_DOCS_DIR = config.DOCS_CONTRIBUTOR_DIRS["brajesh"]

REPORT_MD = BRAJESH_DOCS_DIR / "dask_case_study_report.md"
REPORT_JSON = BRAJESH_RESULTS_DIR / "dask_case_study_report.json"

PANDAS_SUMMARY = config.RESULTS_SOUTH_ASIA_DIR / "pandas_summary.json"
DASK_SUMMARY = BRAJESH_RESULTS_DIR / "dask_large_summary.json"
VALIDATION_SUMMARY = BRAJESH_RESULTS_DIR / "pandas_vs_dask_validation_summary.json"
BENCH_CSV = BRAJESH_RESULTS_DIR / "dask_chunk_benchmark.csv"
BENCH_JSON = BRAJESH_RESULTS_DIR / "dask_chunk_benchmark.json"
REVISION_JSON = BRAJESH_RESULTS_DIR / "dask_revision_experiment.json"
