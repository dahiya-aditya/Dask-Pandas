...
PANDAS_DAILY = config.RESULTS_DIR / "daily_regional_means.csv"
PANDAS_MONTHLY = config.RESULTS_DIR / "large_monthly_climatology.csv"
PANDAS_ANOM = config.RESULTS_DIR / "large_temperature_anomalies.csv"
PANDAS_HEAT = config.RESULTS_DIR / "heat_extreme_daily.csv"

DASK_DAILY = config.RESULTS_DIR / "dask_daily_regional_means.csv"
DASK_MONTHLY = config.RESULTS_DIR / "dask_large_monthly_climatology.csv"
DASK_ANOM = config.RESULTS_DIR / "dask_large_temperature_anomalies.csv"
DASK_HEAT = config.RESULTS_DIR / "dask_heat_extreme_daily.csv"

VALIDATION_CSV = config.RESULTS_DIR / "pandas_vs_dask_validation.csv"
VALIDATION_JSON = config.RESULTS_DIR / "pandas_vs_dask_validation_summary.json"
