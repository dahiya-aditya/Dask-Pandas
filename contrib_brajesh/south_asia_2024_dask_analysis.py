...
DASK_DAILY_RESULTS_CSV = BRAJESH_RESULTS_DIR / "dask_daily_regional_means.csv"
DASK_MONTHLY_RESULTS_CSV = BRAJESH_RESULTS_DIR / "dask_large_monthly_climatology.csv"
DASK_ANOMALY_RESULTS_CSV = BRAJESH_RESULTS_DIR / "dask_large_temperature_anomalies.csv"
DASK_HEAT_RESULTS_CSV = BRAJESH_RESULTS_DIR / "dask_heat_extreme_daily.csv"
DASK_SUMMARY_JSON = BRAJESH_RESULTS_DIR / "dask_large_summary.json"
DASK_BENCH_JSON = BRAJESH_RESULTS_DIR / "dask_run_metrics.json"
...
def run_dask_analysis(
    *,
    ...
    (config.FIGURES_CONTRIBUTOR_DIRS["brajesh"]).mkdir(parents=True, exist_ok=True)
