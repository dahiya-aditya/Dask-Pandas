...
ERA5 reanalysis data was accessed from the Copernicus Climate Data Store
(CDS) \citep{era5_cds}.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.85\textwidth]{figs/anomaly_temperature_timeseries.pdf}
    \caption{Daily temperature anomaly time series (South Asia, 2024).}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.85\textwidth]{figs/anomaly_relationships.pdf}
...
\subsubsection{Effect of Time-Axis Chunk Size}
...
\begin{itemize}
    \item \verb|figs/anomaly_monthly_summary.pdf|
    \item \verb|figs/dask_annual_temperature_cycle.pdf|
    \item \verb|figs/dask_monthly_energy_budget.pdf|
\end{itemize}
